...
Добавим отсутствующие машины в Vagrantfile, также пропишем нужное количество интерфейсов и пропишем в них настройки сетей согласно выше приденной части.
...
Подготовим *ansible.cfg* где пропишем путь к inventory и подтверждение ssh ключа.
...
Запустим playbook *forwarding.yml*, который пропишет во всех роутерах перманентно в *sysctl.conf* пропишет *net.ipv4.ip_forward = 1* для включения пересылки пакетов между интерфейсами. Также для тестов он установит утилиту *mtr* на все наши машины.
